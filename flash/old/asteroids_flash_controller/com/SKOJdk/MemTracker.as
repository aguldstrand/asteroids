package com.SKOJdk
{
	...
	public class MemTracker extends Sprite
	{
		...
		private function init(e:Event):void 
		{
			...
			staticFrameRate = this.stage.frameRate;
			...
			container.x = stage.stageWidth * .5 - container.width * .5;
			trace(container.width);
		}
		
		public function setup(_visible:Boolean = true,_collectDataAllTheTime:Boolean = true,_updateInterval:int = 1, _xpos:int = 0, _chartW:int = 150, _chartH:int = 50, _showMem:Boolean = true,_showFps:Boolean = true, _showCharts:Boolean = true ):void
		{
			if(!isInitialized){				
				isInitialized = true;
				...
				trace(" ERROR @ MemTracker : setup must be run before added to stage ");
			}
		}
